...
async function initializePoolState() {
  try {
    ...
    const tokenAmount = 1000000;  // 1,000,000 STORM tokens
...
async function generateAgents(count, options = {}) {
  ...
  // Store the STORM token in database if not already there
...
function showHelp() {
  console.log(`
Agent Factory - Create agents for Project Storm simulation
