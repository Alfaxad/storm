...
You have a balance of ${agentData.walletBalance || 0} SOL and ${agentData.tokenBalance || 0} STORM tokens.

The current market conditions are:
- STORM token price: 0.01 SOL
...
1. Market Bot (SYSTEM): "STORM token has seen increased volatility today."
2. Alex Smith (AGGRESSIVE): "I'm buying more STORM tokens. Price is going to spike soon!"
...
- STORM tokens: ${agentData.tokenBalance || 0} STORM
